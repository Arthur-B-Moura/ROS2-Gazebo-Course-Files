...
def generate_launch_description():
    ...
    urdf_tutorial_package = FindPackageShare('urdf_tutorial')
    self_launch_package = FindPackageShare('robot_bringup')

    # Enable/Disable JSP_GUI (Joint state publisher gui)
    ...
    ld.add_action(DeclareLaunchArgument(name='urdf_file_path', default_value=PathJoinSubstitution([urdf_tutorial_package, 'urdf', '01-myfirst.urdf']),
    ...
    ld.add_action(IncludeLaunchDescription(
        PathJoinSubstitution([self_launch_package, 'launch', 'absolute_description.launch.py']),
        launch_arguments={
